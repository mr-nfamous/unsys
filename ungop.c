...
#define    UINT_ASTM(K)     ((WORD_TYPE){.U=(K)}).F
#define     INT_ASTM(K)     ((WORD_TYPE){.I=(K)}).F
#define     FLT_ASTM(K)     ((WORD_TYPE){.F=(K)}).F
#define     DBL_ASTM(K)     vdup_n_f64(K)

#define    UINT_ASTV(K)     WWU_ASTV( ((WORD_TYPE){.U=(K)}).F )
#define     INT_ASTV(K)     WWI_ASTV( ((WORD_TYPE){.I=(K)}).F )
#define     FLT_ASTV(K)     WWF_ASTV( ((WORD_TYPE){.F=(K)}).F )
#define     DBL_ASTV(K)     vdup_n_f64(K)

#if defined(SPC_ARM_NEON) && (DWRD_NLONG == 2)
#   define  ULONG_ASTM(K)   ((WORD_TYPE){.U0=(K)}).F
#   define   LONG_ASTM(K)   ((WORD_TYPE){.I0=(K)}).F
#   define ULLONG_ASTM      vdup_n_u64
#   define  LLONG_ASTM      vdup_n_s64

#   define  ULONG_ASTV(K)   ((VWWU_MTYPE){.V0=ULONG_ASTM(K)})
#   define   LONG_ASTV(K)   ((VWWI_MTYPE){.V0= LONG_ASTM(K)})
#   define  LLONG_ASTV       LLONG_ASTM
#   define ULLONG_ASTV      ULLONG_ASTM
    
#elif defined(SPC_ARM_NEON)
#   define  ULONG_ASTM      vdup_n_u64
#   define   LONG_ASTM      vdup_n_s64
#   define ULLONG_ASTM      vdup_n_u64
#   define  LLONG_ASTM      vdup_n_s64

#   define  ULONG_ASTV       ULONG_ASTM
#   define   LONG_ASTV        LONG_ASTM
#   define ULLONG_ASTV      ULLONG_ASTM
#   define  LLONG_ASTV       LLONG_ASTM

#elif defined(SPC_X86_SSE) && (DWRD_NLONG == 2)
#   define  ULONG_ASTM(K)   ((WORD_TYPE){.U=(K)}).F
#   define   LONG_ASTM(K)   ((WORD_TYPE){.I=(K)}).F
#   define ULLONG_ASTM(K)   ((DWRD_TYPE){.U=(K)}).F
#   define  LLONG_ASTM(K)   ((DWRD_TYPE){.I=(K)}).F

#   define  ULONG_ASTV(K)   ((VWWU_TYPE){.V0=ULONG_ASTM(K)})
#   define   LONG_ASTV(K)   ((VWWI_TYPE){.V0= LONG_ASTM(K)})
#   define ULLONG_ASTV(K)   ((VDDU_TYPE){.V0=ULLONG_ASTM(K)})
#   define  LLONG_ASTV(K)   ((VDDI_TYPE){.V0= LLONG_ASTM(K)})
...
#define    CHAR_ASTU(K)     (   (CHAR_STG(TYPE)){.C=(K)}).U
#define   SCHAR_ASTU(K)     (  (SCHAR_STG(TYPE)){.I=(K)}).U
#define    SHRT_ASTU(K)     (   (SHRT_STG(TYPE)){.I=(K)}).U
#define   FLT16_ASTU(K)     (  (FLT16_STG(TYPE)){.F=(K)}).U
#define     INT_ASTU(K)     (    (INT_STG(TYPE)){.I=(K)}).U
#define     FLT_ASTU(K)     (    (FLT_STG(TYPE)){.F=(K)}).U
#define    LONG_ASTU(K)     (   (LONG_STG(TYPE)){.I=(K)}).U
#define   LLONG_ASTU(K)     (  (LLONG_STG(TYPE)){.I=(K)}).U
#define     DBL_ASTU(K)     (    (DBL_STG(TYPE)){.F=(K)}).U
#define  INTPTR_ASTU(K)     ( (INTPTR_STG(TYPE)){.I=(K)}).U
#define PTRDIFF_ASTU(K)     ((PTRDIFF_STG(TYPE)){.I=(K)}).U

#define    CHAR_ASTI(K)     (   (CHAR_STG(TYPE)){.C=(K)}).I
#define   UCHAR_ASTI(K)     (  (UCHAR_STG(TYPE)){.U=(K)}).I
#define   USHRT_ASTI(K)     (  (USHRT_STG(TYPE)){.U=(K)}).I
#define   FLT16_ASTI(K)     (  (FLT16_STG(TYPE)){.F=(K)}).I
#define    UINT_ASTI(K)     (   (UINT_STG(TYPE)){.U=(K)}).I
#define     FLT_ASTI(K)     (    (FLT_STG(TYPE)){.F=(K)}).I
#define   ULONG_ASTI(K)     (  (ULONG_STG(TYPE)){.U=(K)}).I
#define  ULLONG_ASTI(K)     ( (ULLONG_STG(TYPE)){.U=(K)}).I
#define     DBL_ASTI(K)     (    (DBL_STG(TYPE)){.F=(K)}).I
#define    SIZE_ASTI(K)     (   (SIZE_STG(TYPE)){.U=(K)}).I
#define UINTPTR_ASTI(K)     ((UINTPTR_STG(TYPE)){.U=(K)}).I

#define   USHRT_ASTF(K)     (  (USHRT_STG(TYPE)){.U=(K)}).F
#define    SHRT_ASTF(K)     (   (SHRT_STG(TYPE)){.I=(K)}).F
#define    UINT_ASTF(K)     (   (UINT_STG(TYPE)){.U=(K)}).F
#define     INT_ASTF(K)     (    (INT_STG(TYPE)){.I=(K)}).F
#define   ULONG_ASTF(K)     (  (ULONG_STG(TYPE)){.U=(K)}).F
#define    LONG_ASTF(K)     (   (LONG_STG(TYPE)){.I=(K)}).F
#define  ULLONG_ASTF(K)     ( (ULLONG_STG(TYPE)){.U=(K)}).F
#define   LLONG_ASTF(K)     (  (LLONG_STG(TYPE)){.I=(K)}).F
#define    SIZE_ASTF(K)     (   (SIZE_STG(TYPE)){.U=(K)}).F
#define  INTPTR_ASTF(K)     ( (INTPTR_STG(TYPE)){.I=(K)}).F
#define UINTPTR_ASTF(K)     ((UINTPTR_STG(TYPE)){.U=(K)}).F
#define PTRDIFF_ASTF(K)     ((PTRDIFF_STG(TYPE)){.I=(K)}).F

#if 0
#define   UCHAR_ASTU(K)     (  (UCHAR_STG(TYPE)){.U=(K)}).U
#define   USHRT_ASTU(K)     (  (USHRT_STG(TYPE)){.U=(K)}).U
#define    UINT_ASTU(K)     (   (UINT_STG(TYPE)){.U=(K)}).U
#define   ULONG_ASTU(K)     (  (ULONG_STG(TYPE)){.U=(K)}).U
#define  ULLONG_ASTU(K)     ( (ULLONG_STG(TYPE)){.U=(K)}).U
#define    SIZE_ASTU(K)     (   (SIZE_STG(TYPE)){.U=(K)}).U
#define UINTPTR_ASTU(K)     ((UINTPTR_STG(TYPE)){.U=(K)}).U
#define   SCHAR_ASTI(K)     (  (SCHAR_STG(TYPE)){.I=(K)}).I
#define    SHRT_ASTI(K)     (   (SHRT_STG(TYPE)){.I=(K)}).I
#define     INT_ASTI(K)     (    (INT_STG(TYPE)){.I=(K)}).I
#define    LONG_ASTI(K)     (   (LONG_STG(TYPE)){.I=(K)}).I
#define   LLONG_ASTI(K)     (  (LLONG_STG(TYPE)){.I=(K)}).I
#define  INTPTR_ASTI(K)     ( (INTPTR_STG(TYPE)){.I=(K)}).I
#define PTRDIFF_ASTI(K)     ((PTRDIFF_STG(TYPE)){.I=(K)}).I
#define   FLT16_ASTF(K)     (  (FLT16_STG(TYPE)){.F=(K)}).F
#define     FLT_ASTF(K)     (    (FLT_STG(TYPE)){.F=(K)}).F
#define     DBL_ASTF(K)     (    (DBL_STG(TYPE)){.F=(K)}).F

#endif

#define     UCHAR_ASBU       UCHAR_ASTU
#define     SCHAR_ASBU       SCHAR_ASTU
#define     CHAR_ASBU         CHAR_ASTU

#define     UCHAR_ASBI       UCHAR_ASTI
#define     SCHAR_ASBI       SCHAR_ASTI
#define     CHAR_ASBI         CHAR_ASTI

#define     USHRT_ASHU       USHRT_ASTU
#define     SHRT_ASHU         SHRT_ASTU
#define     FLT16_ASHU       FLT16_ASTU

#define     USHRT_ASHI       USHRT_ASTI
#define     SHRT_ASHI         SHRT_ASTI
#define     FLT16_ASHI       FLT16_ASTI

#define     USHRT_ASHF       USHRT_ASTF
#define     SHRT_ASHF         SHRT_ASTF
#define     FLT16_ASHF       FLT16_ASTF

#define     UINT_ASWU         UINT_ASTU
#define     INT_ASWU           INT_ASTU
#define     FLT_ASWU           FLT_ASTU

#define     UINT_ASWI         UINT_ASTI
#define     INT_ASWI           INT_ASTI
#define     FLT_ASWI           FLT_ASTI

#define     UINT_ASWF         UINT_ASTF
#define     INT_ASWF           INT_ASTF
#define     FLT_ASWF           FLT_ASTF

#define     ULLONG_ASDU     ULLONG_ASTU
#define     LLONG_ASDU       LLONG_ASTU
#define     DBL_ASDU           DBL_ASTU

#define     ULLONG_ASDI     ULLONG_ASTI
#define     LLONG_ASDI       LLONG_ASTI
#define     DBL_ASDI           DBL_ASTI

#define     ULLONG_ASDF     ULLONG_ASTF
#define     LLONG_ASDF       LLONG_ASTF
#define     DBL_ASDF           DBL_ASTF
...
/*  vdup_n outputs a more efficient sequence than vcreate
*/
...
//efine     VQYU_ASYU
#define     VQBU_ASYU(V)    DYU_ASTV(QBU_ASYU(VQBU_ASTM(V)))
#define     VQBI_ASYU(V)    DYU_ASTV(QBI_ASYU(VQBI_ASTM(V)))
#define     VQBC_ASYU(V)    DYU_ASTV(QBC_ASYU(VQBC_ASTM(V)))
#define     VQHU_ASYU(V)    DYU_ASTV(QHU_ASYU(VQHU_ASTM(V)))
#define     VQHI_ASYU(V)    DYU_ASTV(QHI_ASYU(VQHI_ASTM(V)))
#define     VQHF_ASYU(V)    DYU_ASTV(QHF_ASYU(VQHF_ASTM(V)))
#define     VQWU_ASYU(V)    DYU_ASTV(QWU_ASYU(VQWU_ASTM(V)))
#define     VQWI_ASYU(V)    DYU_ASTV(QWI_ASYU(VQWI_ASTM(V)))
#define     VQWF_ASYU(V)    DYU_ASTV(QWF_ASYU(VQWF_ASTM(V)))
#define     VQDU_ASYU(V)    DYU_ASTV(QDU_ASYU(VQDU_ASTM(V)))
#define     VQDI_ASYU(V)    DYU_ASTV(QDI_ASYU(VQDI_ASTM(V)))
#define     VQDF_ASYU(V)    DYU_ASTV(QDF_ASYU(VQDF_ASTM(V)))
...
#define     VQYU_ASBI(V)    QYU_ASTV(QYU_ASBI(VQYU_ASTM(V)))
...
INLINE(uint8_t,   BOOL_CVBZ) (_Bool x)
{
#define     BOOL_CVBZ BOOL_CVBZ
    return  x;
}
...
{
#   define  UINT_CVBZ(X)    ((uint8_t)((X)|vtstd_u64((X),0xffffff00u)))
    return  UINT_CVBZ(x);
}
...
{
#   define  ULLONG_CVBZ(X)    \
((uint8_t)((X)|vtstd_u64((X),0xffffffffffffff00ull)))
    return  ULLONG_CVBZ(x);
}

INLINE(uint8_t,  LLONG_CVBZ) (long long x)
{
/* TODO: 
Verify that this convoluted nonsense is actually faster 
than a naive implementation.
*/
#   define  LLONG_CVBZ(X)   vqmovunh_s16(vqmovns_s32(vqmovnd_s64(X)))
    return  LLONG_CVBZ(x);
}
...
INLINE(uint8_t,  ULONG_CVBZ) (unsigned long x)
{
#   define  ULONG_CVBZ  ULLONG_CVBZ
    return  ULLONG_CVBZ(x);
}

INLINE(uint8_t,   LONG_CVBZ) (long x)
{
#   define  LONG_CVBZ   LLONG_CVBZ
    return  LLONG_CVBZ(x);
}
...
#define     VQWU_CVBZ(V)    WHU_ASTV(QWU_CVBZ(V))
    return  VQWU_CVBZ(v);
}
...
#define     VDWI_CVHZ(X)    WHI_ASTV(DWI_CVHZ(X))
    return  VDWI_CVHZ(x);
}
...
#define     VDDU_CVWZ(X)    WWU_ASTV(DDU_CVWZ(X))
    return  VDDU_CVWZ(x);
}

INLINE(Vwwu,VDDI_CVWZ) (Vddi x)
{
#define     DDI_CVWZ(V)     \
vget_lane_f32(              \
    vreinterpret_f32_u32(   \
...
#define     VDDI_CVWZ(X)    WWU_ASTV(DDI_CVWZ(X))
    return  VDDI_CVWZ(x);
}
...
#define     DYU_DUPD(X)     vdup_n_u64(0ull-(_Bool)(X))
#define     DBU_DUPD(X)     vdup_n_u8(X)
#define     DBI_DUPD(X)     vdup_n_s8(X)
#if CHAR_MIN
#   define  DBC_DUPD(X)     vdup_n_s8(X)
#else
#   define  DBC_DUPD(X)     vdup_n_u8(X)
#endif

#define     DHU_DUPD(X)     vdup_n_u16(X)
#define     DHI_DUPD(X)     vdup_n_s16(X)
#define     DHF_DUPD(X)     vdup_n_f16(X)

#define     DWU_DUPD(X)     vdup_n_u32(X)
#define     DWI_DUPD(X)     vdup_n_s32(X)
#define     DWF_DUPD(X)     vdup_n_f32(X)
...
INLINE(Vdyu,VDYU_DUPD) (_Bool x)
{
#define     VDYU_DUPD(X)    DYU_ASTV(DYU_DUPD(X))
    return  VDYU_DUPD(x);
}


INLINE(Vdbu,VDBU_DUPD) (uint8_t x)
{
#define     VDBU_DUPD       DBU_DUPD
    return  VDBU_DUPD(x);
}

INLINE(Vdbi,VDBI_DUPD) (int8_t x)
{
#define     VDBI_DUPD       DBI_DUPD
    return  VDBI_DUPD(x);
}

INLINE(Vdbc,VDBC_DUPD) (char x)
{
#define     VDBC_DUPD(X)    DBC_ASTV(DBC_DUPD(X))
    return  VDBC_DUPD(x);
}


INLINE(Vdhu,VDHU_DUPD) (uint16_t x)
{
#define     VDHU_DUPD       DHU_DUPD
    return  VDHU_DUPD(x);
}

INLINE(Vdhi,VDHI_DUPD) (int16_t x)
{
#define     VDHI_DUPD       DHI_DUPD
    return  VDHI_DUPD(x);
}

INLINE(Vdhf,VDHF_DUPD) (flt16_t x)
{
#define     VDHF_DUPD       DHF_DUPD
    return  VDHF_DUPD(x);
}


INLINE(Vdwu,VDWU_DUPD) (uint32_t x)
{
#define     VDWU_DUPD       DWU_DUPD
    return  VDWU_DUPD(x);
}

INLINE(Vdwi,VDWI_DUPD) (int32_t x)
{
#define     VDWI_DUPD       DWI_DUPD
    return  VDWI_DUPD(x);
}

INLINE(Vdwf,VDWF_DUPD) (float x)
{
#define     VDWF_DUPD       DWF_DUPD
    return  VDWF_DUPD(x);
}
...
#define     ABC_LDRW(a)     ((VWBC_TYPE){*(VWBC_MTYPE *)(a)})
#define     ABU_LDRW(a)     ((VWBU_TYPE){*(VWBU_MTYPE *)(a)})
#define     ABI_LDRW(a)     ((VWBI_TYPE){*(VWBI_MTYPE *)(a)})
#define     AHU_LDRW(a)     ((VWHU_TYPE){*(VWHU_MTYPE *)(a)})
#define     AHI_LDRW(a)     ((VWHI_TYPE){*(VWHI_MTYPE *)(a)})
#define     AHF_LDRW(a)     ((VWHF_TYPE){*(VWHF_MTYPE *)(a)})
#define     AWU_LDRW(a)     ((VWWU_TYPE){*(VWWU_MTYPE *)(a)})
#define     AWI_LDRW(a)     ((VWWI_TYPE){*(VWWI_MTYPE *)(a)})
#define     AWF_LDRW(a)     ((VWWF_TYPE){*(VWWF_MTYPE *)(a)})
...
#if CHAR_SIGNEDNESS
#   define  ABC_LDRD(p)     vld1_s8((signed char const *)(p))
#else
#   define  ABC_LDRD(p)     vld1_u8((unsigned char const *)(p))
#endif

#define     ABU_LDRD        vld1_u8
#define     ABI_LDRD        vld1_s8
#define     AHU_LDRD        vld1_u16
#define     AHI_LDRD        vld1_s16
#define     AHF_LDRD        vld1_f16
#define     AWU_LDRD        vld1_u32
#define     AWI_LDRD        vld1_s32
#define     AWF_LDRD        vld1_f32
#define     ADU_LDRD        vld1_u64
#define     ADI_LDRD        vld1_s64
#define     ADF_LDRD        vld1_f64
...
#if CHAR_SIGNEDNESS
#   define  ABC_LDRQ(p)     vld1q_s8((signed char const *)(p))
#else
#   define  ABC_LDRQ(p)     vld1q_u8((unsigned char const *)(p))
#endif
#define     ABU_LDRQ        vld1q_u8
#define     ABI_LDRQ        vld1q_s8
#define     AHU_LDRQ        vld1q_u16
#define     AHI_LDRQ        vld1q_s16
#define     AHF_LDRQ        vld1q_f16
#define     AWU_LDRQ        vld1q_u32
#define     AWI_LDRQ        vld1q_s32
#define     AWF_LDRQ        vld1q_f32
#define     ADU_LDRQ        vld1q_u64
#define     ADI_LDRQ        vld1q_s64
#define     ADF_LDRQ        vld1q_f64
...
//  astu: KV_BDS
PUBLIC(  Bu, astubi )(  Bi src);
PUBLIC(  Hu, astuhi )(  Hi src);
PUBLIC(  Hu, astuhf )(  Hf src);
PUBLIC(  Wu, astuwi )(  Wi src);
PUBLIC(  Wu, astuwf )(  Wf src);
PUBLIC(  Du, astudi )(  Di src);
PUBLIC(  Du, astudf )(  Df src);

PUBLIC(Vwbu, astuwbi)(Vwbi src);
PUBLIC(Vwhu, astuwhi)(Vwhi src);
PUBLIC(Vwhu, astuwhf)(Vwhf src);
PUBLIC(Vwwu, astuwwi)(Vwwi src);
PUBLIC(Vwwu, astuwwf)(Vwwf src);

PUBLIC(Vdbu, astudbi)(Vdbi src);
PUBLIC(Vdhu, astudhi)(Vdhi src);
PUBLIC(Vdhu, astudhf)(Vdhf src);
PUBLIC(Vdwu, astudwi)(Vdwi src);
PUBLIC(Vdwu, astudwf)(Vdwf src);
PUBLIC(Vddu, astuddi)(Vddi src);
PUBLIC(Vddf, astuddf)(Vddf src);

PUBLIC(Vqbu, astuqbi)(Vqbi src);
PUBLIC(Vqhu, astuqhi)(Vqhi src);
PUBLIC(Vqhu, astuqhf)(Vqhf src);
PUBLIC(Vqwu, astuqwi)(Vqwi src);
PUBLIC(Vqwu, astuqwf)(Vqwf src);
PUBLIC(Vqdu, astuqdi)(Vqdi src);
PUBLIC(Vqdf, astuqdf)(Vqdf src);

PUBLIC(Vobu, astuobi)(Vobi src);
PUBLIC(Vohu, astuohi)(Vohi src);
PUBLIC(Vohu, astuohf)(Vohf src);
PUBLIC(Vowu, astuowi)(Vowi src);
PUBLIC(Vowu, astuowf)(Vowf src);
PUBLIC(Vodu, astuodi)(Vodi src);
PUBLIC(Vodf, astuodf)(Vodf src);

PUBLIC(Vsbu, astusbi)(Vsbi src);
PUBLIC(Vshu, astushi)(Vshi src);
PUBLIC(Vshu, astushf)(Vshf src);
PUBLIC(Vswu, astuswi)(Vswi src);
PUBLIC(Vswu, astuswf)(Vswf src);
PUBLIC(Vsdu, astusdi)(Vsdi src);
PUBLIC(Vsdf, astusdf)(Vsdf src);


//  asti: KV_BDN
PUBLIC(  Bi, astibu )(  Bu src);
PUBLIC(  Hi, astihu )(  Hu src);
PUBLIC(  Hi, astihf )(  Hf src);
PUBLIC(  Wi, astiwu )(  Wu src);
PUBLIC(  Wi, astiwf )(  Wf src);
PUBLIC(  Di, astidu )(  Du src);
PUBLIC(  Di, astidf )(  Df src);
PUBLIC(Vwbi, astiwbu)(Vwbu a);
PUBLIC(Vwhi, astiwhu)(Vwhu a);
PUBLIC(Vwhi, astiwhf)(Vwhf a);
PUBLIC(Vwwi, astiwwu)(Vwwu a);
PUBLIC(Vwwi, astiwwf)(Vwwf a);

PUBLIC(Vdbi, astidbu)(Vdbu a);
PUBLIC(Vdhi, astidhu)(Vdhu a);
PUBLIC(Vdhi, astidhf)(Vdhf a);
PUBLIC(Vdwi, astidwu)(Vdwu a);
PUBLIC(Vdwi, astidwf)(Vdwf a);
PUBLIC(Vddi, astiddu)(Vddu a);
PUBLIC(Vddi, astiddf)(Vddf a);

PUBLIC(Vqbi, astiqbu)(Vqbu a);
PUBLIC(Vqhi, astiqhu)(Vqhu a);
PUBLIC(Vqhi, astiqhf)(Vqhf a);
PUBLIC(Vqwi, astiqwu)(Vqwu a);
PUBLIC(Vqwi, astiqwf)(Vqwf a);
PUBLIC(Vqdi, astiqdu)(Vqdu a);
PUBLIC(Vqdi, astiqdf)(Vqdf a);

PUBLIC(Vobi, astiobu)(Vobu a);
PUBLIC(Vohi, astiohu)(Vohu a);
PUBLIC(Vohi, astiohf)(Vohf a);
PUBLIC(Vowi, astiowu)(Vowu a);
PUBLIC(Vowi, astiowf)(Vowf a);
PUBLIC(Vodi, astiodu)(Vodu a);
PUBLIC(Vodi, astiodf)(Vodf a);

PUBLIC(Vsbi, astisbu)(Vsbu a);
PUBLIC(Vshi, astishu)(Vshu a);
PUBLIC(Vshi, astishf)(Vshf a);
PUBLIC(Vswi, astiswu)(Vswu a);
PUBLIC(Vswi, astiswf)(Vswf a);
PUBLIC(Vsdi, astisdu)(Vsdu a);
PUBLIC(Vsdi, astisdf)(Vsdf a);

//  astf: KV_HDZ
PUBLIC(  Hf, astfhu )(  Hu src);
PUBLIC(  Hf, astfhi )(  Hi src);
PUBLIC(  Wi, astfwu )(  Wu src);
PUBLIC(  Wi, astfwi )(  Wi src);
PUBLIC(  Di, astfdu )(  Du src);
PUBLIC(  Di, astfdi )(  Di src);
PUBLIC(Vwhf, astfwhu)(Vwhu a);
PUBLIC(Vwhf, astfwhi)(Vwhi a);
PUBLIC(Vwwf, astfwwu)(Vwwu a);
PUBLIC(Vwwf, astfwwi)(Vwwi a);

PUBLIC(Vdhf, astfdhu)(Vdhu a);
PUBLIC(Vdhf, astfdhi)(Vdhi a);
PUBLIC(Vdwf, astfdwu)(Vdwu a);
PUBLIC(Vdwf, astfdwi)(Vdwi a);
PUBLIC(Vddf, astfddu)(Vddu a);
PUBLIC(Vddf, astfddi)(Vddi a);

PUBLIC(Vqhf, astfqhu)(Vqhu a);
PUBLIC(Vqhf, astfqhi)(Vqhi a);
PUBLIC(Vqwf, astfqwu)(Vqwu a);
PUBLIC(Vqwf, astfqwi)(Vqwi a);
PUBLIC(Vqdf, astfqdu)(Vqdu a);
PUBLIC(Vqdf, astfqdi)(Vqdi a);

PUBLIC(Vohf, astfohu)(Vohu a);
PUBLIC(Vohf, astfohi)(Vohi a);
PUBLIC(Vowf, astfowu)(Vowu a);
PUBLIC(Vowf, astfowi)(Vowi a);
PUBLIC(Vodf, astfodu)(Vodu a);
PUBLIC(Vodf, astfodi)(Vodi a);

PUBLIC(Vshf, astfshu)(Vshu a);
PUBLIC(Vshf, astfshi)(Vshi a);
PUBLIC(Vswf, astfswu)(Vswu a);
PUBLIC(Vswf, astfswi)(Vswi a);
PUBLIC(Vsdf, astfsdu)(Vsdu a);
PUBLIC(Vsdf, astfsdi)(Vsdi a);

// asyu:
PUBLIC(Vdyu, asyudbu)(Vdbu a);
PUBLIC(Vdyu, asyudbi)(Vdbi a);
PUBLIC(Vdyu, asyudbc)(Vdbc a);
PUBLIC(Vdyu, asyudhu)(Vdhu a);
PUBLIC(Vdyu, asyudhi)(Vdhi a);
PUBLIC(Vdyu, asyudhf)(Vdhf a);
PUBLIC(Vdyu, asyudwu)(Vdwu a);
PUBLIC(Vdyu, asyudwi)(Vdwi a);
PUBLIC(Vdyu, asyudwf)(Vdwf a);
PUBLIC(Vdyu, asyuddu)(Vddu a);
PUBLIC(Vdyu, asyuddi)(Vddi a);
PUBLIC(Vdyu, asyuddf)(Vddf a);

PUBLIC(Vqyu, asyuqbu)(Vqbu a);
PUBLIC(Vqyu, asyuqbi)(Vqbi a);
PUBLIC(Vqyu, asyuqhu)(Vqhu a);
PUBLIC(Vqyu, asyuqhi)(Vqhi a);
PUBLIC(Vqyu, asyuqhf)(Vqhf a);
PUBLIC(Vqyu, asyuqwu)(Vqwu a);
PUBLIC(Vqyu, asyuqwi)(Vqwi a);
PUBLIC(Vqyu, asyuqwf)(Vqwf a);
PUBLIC(Vqyu, asyuqdu)(Vqdu a);
PUBLIC(Vqyu, asyuqdi)(Vqdi a);
PUBLIC(Vqyu, asyuqdf)(Vqdf a);

// asbu
PUBLIC(uint8_t, asbubi)(int8_t a);
PUBLIC(uint8_t, asbubc)(char a);

PUBLIC(Vwbu, asbuwyu)(Vwyu a);
PUBLIC(Vwbu, asbuwbi)(Vwbi a);
PUBLIC(Vwbu, asbuwbc)(Vwbc a);
PUBLIC(Vwbu, asbuwhu)(Vwhu a);
PUBLIC(Vwbu, asbuwhi)(Vwhi a);
PUBLIC(Vwbu, asbuwhf)(Vwhf a);
PUBLIC(Vwbu, asbuwwu)(Vwwu a);
PUBLIC(Vwbu, asbuwwi)(Vwwi a);
PUBLIC(Vwbu, asbuwwf)(Vwwf a);

PUBLIC(Vdbu, asbudyu)(Vdyu a);
PUBLIC(Vdbu, asbudbi)(Vdbi a);
PUBLIC(Vdbu, asbudbc)(Vdbc a);
PUBLIC(Vdbu, asbudhu)(Vdhu a);
PUBLIC(Vdbu, asbudhi)(Vdhi a);
PUBLIC(Vdbu, asbudhf)(Vdhf a);
PUBLIC(Vdbu, asbudwu)(Vdwu a);
PUBLIC(Vdbu, asbudwi)(Vdwi a);
PUBLIC(Vdbu, asbudwf)(Vdwf a);
PUBLIC(Vdbu, asbuddu)(Vddu a);
PUBLIC(Vdbu, asbuddi)(Vddi a);
PUBLIC(Vdbu, asbuddf)(Vddf a);

PUBLIC(Vqbu, asbuqyu)(Vqyu a);
PUBLIC(Vqbu, asbuqbi)(Vqbi a);
PUBLIC(Vqbu, asbuqbc)(Vqbc a);
PUBLIC(Vqbu, asbuqhu)(Vqhu a);
PUBLIC(Vqbu, asbuqhi)(Vqhi a);
PUBLIC(Vqbu, asbuqhf)(Vqhf a);
PUBLIC(Vqbu, asbuqwu)(Vqwu a);
PUBLIC(Vqbu, asbuqwi)(Vqwi a);
PUBLIC(Vqbu, asbuqwf)(Vqwf a);
PUBLIC(Vqbu, asbuqdu)(Vqdu a);
PUBLIC(Vqbu, asbuqdi)(Vqdi a);
PUBLIC(Vqbu, asbuqdf)(Vqdf a);

// asbi:
PUBLIC(int8_t, asbibu)(uint8_t a);
PUBLIC(int8_t, asbibc)(char a);

PUBLIC(Vwbi, asbiwyu)(Vwyu a);
PUBLIC(Vwbi, asbiwbu)(Vwbu a);
PUBLIC(Vwbi, asbiwbc)(Vwbc a);
PUBLIC(Vwbi, asbiwhu)(Vwhu a);
PUBLIC(Vwbi, asbiwhi)(Vwhi a);
PUBLIC(Vwbi, asbiwhf)(Vwhf a);
PUBLIC(Vwbi, asbiwwu)(Vwwu a);
PUBLIC(Vwbi, asbiwwi)(Vwwi a);
PUBLIC(Vwbi, asbiwwf)(Vwwf a);

PUBLIC(Vdbi, asbidyu)(Vdyu a);
PUBLIC(Vdbi, asbidbu)(Vdbu a);
PUBLIC(Vdbi, asbidbc)(Vdbc a);
PUBLIC(Vdbi, asbidhu)(Vdhu a);
PUBLIC(Vdbi, asbidhi)(Vdhi a);
PUBLIC(Vdbi, asbidhf)(Vdhf a);
PUBLIC(Vdbi, asbidwu)(Vdwu a);
PUBLIC(Vdbi, asbidwi)(Vdwi a);
PUBLIC(Vdbi, asbidwf)(Vdwf a);
PUBLIC(Vdbi, asbiddu)(Vddu a);
PUBLIC(Vdbi, asbiddi)(Vddi a);
PUBLIC(Vdbi, asbiddf)(Vddf a);

PUBLIC(Vqbi, asbiqyu)(Vqbu a);
PUBLIC(Vqbi, asbiqbu)(Vqbu a);
PUBLIC(Vqbi, asbiqbi)(Vqbi a);
PUBLIC(Vqbi, asbiqbc)(Vqbc a);
PUBLIC(Vqbi, asbiqhu)(Vqhu a);
PUBLIC(Vqbi, asbiqhi)(Vqhi a);
PUBLIC(Vqbi, asbiqhf)(Vqhf a);
PUBLIC(Vqbi, asbiqwu)(Vqwu a);
PUBLIC(Vqbi, asbiqwi)(Vqwi a);
PUBLIC(Vqbi, asbiqwf)(Vqwf a);
PUBLIC(Vqbi, asbiqdu)(Vqdu a);
PUBLIC(Vqbi, asbiqdi)(Vqdi a);
PUBLIC(Vqbi, asbiqdf)(Vqdf a);

// asbc:
PUBLIC(char, asbcbu)(uint8_t a);
PUBLIC(char, asbcbi)(int8_t a);

PUBLIC(Vwbc, asbcwyu)(Vwbu a);
PUBLIC(Vwbc, asbcwbu)(Vwbu a);
PUBLIC(Vwbc, asbcwbi)(Vwbi a);
PUBLIC(Vwbc, asbcwhu)(Vwhu a);
PUBLIC(Vwbc, asbcwhi)(Vwhi a);
PUBLIC(Vwbc, asbcwhf)(Vwhf a);
PUBLIC(Vwbc, asbcwwu)(Vwwu a);
PUBLIC(Vwbc, asbcwwi)(Vwwi a);
PUBLIC(Vwbc, asbcwwf)(Vwwf a);

PUBLIC(Vdbc, asbcdyu)(Vdbu a);
PUBLIC(Vdbc, asbcdbu)(Vdbu a);
PUBLIC(Vdbc, asbcdbi)(Vdbi a);
PUBLIC(Vdbc, asbcdhu)(Vdhu a);
PUBLIC(Vdbc, asbcdhi)(Vdhi a);
PUBLIC(Vdbc, asbcdhf)(Vdhf a);
PUBLIC(Vdbc, asbcdwu)(Vdwu a);
PUBLIC(Vdbc, asbcdwi)(Vdwi a);
PUBLIC(Vdbc, asbcdwf)(Vdwf a);
PUBLIC(Vdbc, asbcddu)(Vddu a);
PUBLIC(Vdbc, asbcddi)(Vddi a);
PUBLIC(Vdbc, asbcddf)(Vddf a);

PUBLIC(Vqbc, asbcqyu)(Vqyu a);
PUBLIC(Vqbc, asbcqbu)(Vqbu a);
PUBLIC(Vqbc, asbcqbi)(Vqbi a);
PUBLIC(Vqbc, asbcqhu)(Vqhu a);
PUBLIC(Vqbc, asbcqhi)(Vqhi a);
PUBLIC(Vqbc, asbcqhf)(Vqhf a);
PUBLIC(Vqbc, asbcqwu)(Vqwu a);
PUBLIC(Vqbc, asbcqwi)(Vqwi a);
PUBLIC(Vqbc, asbcqwf)(Vqwf a);
PUBLIC(Vqbc, asbcqdu)(Vqdu a);
PUBLIC(Vqbc, asbcqdi)(Vqdi a);
PUBLIC(Vqbc, asbcqdf)(Vqdf a);

// ashu:
PUBLIC(uint16_t, ashuhi)(uint16_t a);
PUBLIC(uint16_t, ashuhf)(flt16_t a);

PUBLIC(Vwhu, ashuwyu)(Vwyu a);
PUBLIC(Vwhu, ashuwbu)(Vwbu a);
PUBLIC(Vwhu, ashuwbi)(Vwbi a);
PUBLIC(Vwhu, ashuwbc)(Vwbc a);
PUBLIC(Vwhu, ashuwhu)(Vwhu a);
PUBLIC(Vwhu, ashuwhi)(Vwhi a);
PUBLIC(Vwhu, ashuwhf)(Vwhf a);
PUBLIC(Vwhu, ashuwwu)(Vwwu a);
PUBLIC(Vwhu, ashuwwi)(Vwwi a);
PUBLIC(Vwhu, ashuwwf)(Vwwf a);

PUBLIC(Vdhu, ashudyu)(Vdyu a);
PUBLIC(Vdhu, ashudbu)(Vdbu a);
PUBLIC(Vdhu, ashudbi)(Vdbi a);
PUBLIC(Vdhu, ashudbc)(Vdbc a);
PUBLIC(Vdhu, ashudhu)(Vdhu a);
PUBLIC(Vdhu, ashudhi)(Vdhi a);
PUBLIC(Vdhu, ashudhf)(Vdhf a);
PUBLIC(Vdhu, ashudwu)(Vdwu a);
PUBLIC(Vdhu, ashudwi)(Vdwi a);
PUBLIC(Vdhu, ashudwf)(Vdwf a);
PUBLIC(Vdhu, ashuddu)(Vddu a);
PUBLIC(Vdhu, ashuddi)(Vddi a);
PUBLIC(Vdhu, ashuddf)(Vddf a);

PUBLIC(Vqhu, ashuqyu)(Vqyu a);
PUBLIC(Vqhu, ashuqbu)(Vqbu a);
PUBLIC(Vqhu, ashuqbi)(Vqbi a);
PUBLIC(Vqhu, ashuqbc)(Vqbc a);
PUBLIC(Vqhu, ashuqhu)(Vqhu a);
PUBLIC(Vqhu, ashuqhi)(Vqhi a);
PUBLIC(Vqhu, ashuqhf)(Vqhf a);
PUBLIC(Vqhu, ashuqwu)(Vqwu a);
PUBLIC(Vqhu, ashuqwi)(Vqwi a);
PUBLIC(Vqhu, ashuqwf)(Vqwf a);
PUBLIC(Vqhu, ashuqdu)(Vqdu a);
PUBLIC(Vqhu, ashuqdi)(Vqdi a);
PUBLIC(Vqhu, ashuqdf)(Vqdf a);
...
NOTE: there will be some functionality overlap here. E.g.
cvhubu and cvhzbu generate identical results. 
*/
...
// vstl
PUBLIC(  Hu, vstlhu )(  Hu v,   Bu l);
PUBLIC(  Hi, vstlhi )(  Hi v,   Bi l);

PUBLIC(  Wu, vstlwu )(  Wu v,   Hu l);
PUBLIC(  Wi, vstlwi )(  Wi v,   Hi l);

PUBLIC(  Du, vstldu )(  Du v,   Wu l);
PUBLIC(  Di, vstldi )(  Di v,   Wi l);

PUBLIC(Vdyu, vstldyu)(Vdyu v, Vwyu l);
PUBLIC(Vqyu, vstlqyu)(Vqyu v, Vdyu l);
PUBLIC(Voyu, vstloyu)(Voyu v, Vqyu l);
PUBLIC(Vsyu, vstlsyu)(Vsyu v, Voyu l);

// vstr
PUBLIC(  Hu, vstrhu )(  Hu v,   Bu r);
PUBLIC(  Hi, vstrhi )(  Hi v,   Bi r);
PUBLIC(  Wu, vstrwu )(  Wu v,   Hu r);
PUBLIC(  Wi, vstrwi )(  Wi v,   Hi r);
PUBLIC(  Du, vstrdu )(  Du v,   Wu r);
PUBLIC(  Di, vstrdi )(  Di v,   Wi r);
PUBLIC(Vdyu, vstrdyu)(Vdyu v, Vwyu r);
PUBLIC(Vqyu, vstrqyu)(Vqyu v, Vdyu r);
PUBLIC(Voyu, vstroyu)(Voyu v, Vqyu r);
PUBLIC(Vsyu, vstrsyu)(Vsyu v, Voyu r);

// vsty
PUBLIC(Vwyu, vstywyu)(Vwyu dst, Vwyu src, Rc(0, 31) bit, Rc(1, 32-bit) len);

PUBLIC(Vdyu, vstydyu)(Vdyu dst, Vdyu src, Rc(0, 63) bit, Rc(1, 64-bit) len);

PUBLIC(Vqyu, vstyqyu)(Vqyu dst, Vqyu src, Rc(0,127) bit, Rc(1,128-bit) len);

PUBLIC(Voyu, vstyoyu)(Voyu dst, Voyu src, Rc(0,255) bit, Rc(1,256-bit) len);

PUBLIC(Vsyu, vstysyu)(Vsyu dst, Vsyu src, Rc(0,511) bit, Rc(1,512-bit) len);

// vstb
PUBLIC(  Bu, vstbbu )(  Bu dst, Bu src, Rc(0, 7) bit, Rc(1, 8) len);
PUBLIC(  Bi, vstbbi )(  Bi dst, Bi src, Rc(0, 7) bit, Rc(1, 8) len);

// vsth
PUBLIC(  Hu, vsthhu )(  Hu dst, Hu src, Rc(0,15) bit, Rc(1,16) len);
PUBLIC(  Hi, vsthhi )(  Hi dst, Hi src, Rc(0,15) bit, Rc(1,16) len);

// vstw
PUBLIC(  Wu, vstwwu )(  Wu dst, Wu src, Rc(0,31) bit, Rc(1,32) len);
PUBLIC(  Wi, vstwwi )(  Wi dst, Wi src, Rc(0,31) bit, Rc(1,32) len);
PUBLIC(Vwyu, vstwwyu)(Vwyu dst, Yu src, Rc(0,31) k);
PUBLIC(Vwbu, vstwwbu)(Vwbu dst, Bu src, Rc(0, 3) k);

// vstd
PUBLIC(  Du, vstddu )(  Du dst, Du src, Rc(0,63) bit, Rc(1,64) len);
PUBLIC(  Di, vstddi )(  Di dst, Di src, Rc(0,63) bit, Rc(1,64) len);
PUBLIC(Vdyu, vstddyu)(Vdyu dst, Yu src, Rc(0,63) k);
PUBLIC(Vdbu, vstddbu)(Vdbu dst, Bu src, Rc(0, 7) k);

// vstq
PUBLIC(Vqyu, vstqqyu)(Vqyu dst, Yu src, Rc(0,127) k);
PUBLIC(Vqbu, vstqqbu)(Vqbu dst, Bu src, Rc(0, 15) k);

// vsto
PUBLIC(Voyu, vstooyu)(Vdyu dst, Yu src, Rc(0,255) k);
PUBLIC(Vobu, vstoobu)(Vobu dst, Bu src, Rc(0, 31) k);

// vsts
PUBLIC(Vsyu, vstssyu)(Vsyu dst, Yu src, Rc(0,511) k);
PUBLIC(Vsbu, vstssbu)(Vsbu dst, Bu src, Rc(0, 63) k);
...
PUBLIC(   _Bool, ldr1ayu) (   _Bool volatile const a[1]);
PUBLIC(    char, ldr1abc) (    char volatile const a[1]);
PUBLIC( uint8_t, ldr1abu) ( uint8_t volatile const a[1]);
PUBLIC(  int8_t, ldr1abi) (  int8_t volatile const a[1]);
PUBLIC(uint16_t, ldr1ahu) (uint16_t volatile const a[1]);
PUBLIC( int16_t, ldr1ahi) ( int16_t volatile const a[1]);
PUBLIC(uint32_t, ldr1awu) (uint32_t volatile const a[1]);
PUBLIC( int32_t, ldr1awi) ( int32_t volatile const a[1]);
PUBLIC(uint64_t, ldr1adu) (uint64_t volatile const a[1]);
PUBLIC( int64_t, ldr1adi) ( int64_t volatile const a[1]);
...
#define ldr1(a) (ldr1_funcof(a)(a))

#define ldrw_funcof(a)      \
FUNCOF(                     \
    ldrwa, *(a),            \
    BWR,    /* TGK */       \
    NONE,   /* TGW */       \
...
#define ldrw(a) (ldrw_funcof(a)(a))

#define ldrd_funcof(a)      \
FUNCOF(                     \
    ldrda, *(a),            \
    BDR,    /* TGK */       \
    NONE,   /* TGW */       \
